---
title: "**Data visualization in R**<br><font color='#A8A8A8' size='5'>First steps with `ggplot2`</font><img src='https://www.construction21.org/espana/data/sources/users/8/images/logoesci-fons-blanc.png' style='position:absolute;top:0px;left:0px;' width='10%'/>"
...
##### &emsp;<i class="fas fa-comment-dots"></i> When mapping a continuous variable such as 'qsec' to 'colour', we visualize a gradient of colours representing the continuous values of the variable.
##### &emsp;<i class="fas fa-comment-dots"></i> When mapping it to the 'shape' attribute instead, we get an error 
&emsp;
</div>
...
<div style="background-color:#F0F0F0">
##### &emsp;<i class="fas fa-comment-dots"></i> Answer:
##### &emsp;<i class="fas fa-comment-dots"></i> The 'position' argument that standardises the bars to the same height is "fill"
&emsp;
</div>
...
<div style="background-color:#F0F0F0">
##### &emsp;<i class="fas fa-comment-dots"></i> Answer:
##### &emsp;<i class="fas fa-comment-dots"></i> If you wanted to compare the total amount of cars with each cylinder category, the position adjustment you should choose is the default "stack" attribute; instead if you were interested in knowing the relative abundance of each type of transmission, the position adjustment you should choose is "fill"
&emsp;
</div>
...
<div style="background-color:#F0F0F0">
##### &emsp;<i class="fas fa-comment-dots"></i> Answer:
##### &emsp;<i class="fas fa-comment-dots"></i> I think the best subplot configurations would be the `facet_wrap` function, because the different heights of the histogram are more easily comparable
&emsp;
</div>
...
<div style="background-color:#F0F0F0">
##### &emsp;<i class="fas fa-comment-dots"></i> Answer:
##### &emsp;<i class="fas fa-comment-dots"></i> In order to ensure that colourblind people can distinguish the colours, it's better to use the `scale_fill_viridis_d` palette.
&emsp;
</div>
...
<div style="background-color:#F0F0F0">
##### &emsp;<i class="fas fa-comment-dots"></i> Answer:
##### &emsp;<i class="fas fa-comment-dots"></i> `subtitle` adds a subtitle below the title;
##### &emsp;<i class="fas fa-comment-dots"></i> `caption` adds a caption below the plot;
##### &emsp;<i class="fas fa-comment-dots"></i> `tag` adds an identification tag;
&emsp;
</div>
...
<div style="background-color:#F0F0F0">
##### &emsp;<i class="fas fa-comment-dots"></i> Answer:
##### &emsp;<i class="fas fa-comment-dots"></i> I think the theme which maximizes the data-ink ratio while still clearly showing the data is `theme_minimal`.
&emsp;
</div>
...
<div style="background-color:#F0F0F0">
##### &emsp;<i class="fas fa-comment-dots"></i> Answer:
##### &emsp;<i class="fas fa-comment-dots"></i> We can observe that the raster format (PNG file) has a much lower resolution compared to the vector format (SVG file), which can be zoomed on without loosing resolution.
&emsp;
</div>
...
e <- ggplot(data = economics, mapping = aes(x = date, y = unemploy)) + 
  geom_line() + 
  labs(title = "Unemploy Plot", x = "Date", y = "Unemploy")
e
ggsave(filename = "plot.png", plot = e)
```
